...
<section class="form-container">
   ...
   <form action="login_registration.php" method="POST" >
      <h3>login now</h3>
      <p>Your email or Username<span>*</span></p>
      <input type="text" name="email_username" placeholder="Enter your email or username" required  class="box">
      <p>Your password <span>*</span></p>
      <input type="password" name="password" placeholder="Enter your password" required  class="box">
      <input type="submit" value="login new" name="login" class="btn">
      <p style="text-align: center;">or</p>
      <div style="display: flex; justify-content: space-between;">
         <p>I don't have account</p>
         <a href="register.php" style="font-size: 3rem;">Register</a>
      </div>
