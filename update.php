...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>update name</p>
      <input type="text" name="name" placeholder="abhishek yadav" maxlength="50" class="box">
      <p>update email</p>
      <input type="email" name="email" placeholder="abhishek@gmail.com" maxlength="50" class="box">
